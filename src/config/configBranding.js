import logoImageDesktop from '../assets/horizon-labs-logo-desktop.svg';
import logoImageMobile from '../assets/horizon-labs-logo-mobile.svg';
...
export const marketplaceColor = '#1a1a2e';
